      ...
      <div className='max-w-6xl mx-auto flex justify-between items-center'>
        <div className='flex gap-7 items-center'>
          ...
          {/* <div className='md:flex gap-1 cursor-pointer text-gray-700 items-center hidden'>
            ...
            <span className='font-semibold'>{location ? <div className='-space-y-2'><p>{location.county}</p><p>{location.state}</p></div> : "Add Address"}</span>
        ...
        <nav className='flex gap-7 items-center'>
          <ul className='md:flex gap-7 items-center text-xl font-semibold hidden'>
            <NavLink to='/' className={({ isActive }) => isActive ? "border-b-3 border-red-500 cursor-pointer" : "text-black cursor-pointer"}>Home</NavLink>
            <NavLink to='/products' className={({ isActive }) => isActive ? "border-b-3 border-red-500 cursor-pointer" : "text-black cursor-pointer"}>Products</NavLink>
            <NavLink to='/about' className={({ isActive }) => isActive ? "border-b-3 border-red-500 cursor-pointer" : "text-black cursor-pointer"}>About</NavLink>
            <NavLink to='/contact' className={({ isActive }) => isActive ? "border-b-3 border-red-500 cursor-pointer" : "text-black cursor-pointer"}>Contact</NavLink>
          </ul>
